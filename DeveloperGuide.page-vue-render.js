...
with(this){return _c('ul',[_c('li',[_v("The methods for the addition of remark, module and telegram handle field were adapted from AB3 Tutorial 2.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('strong',[_v("API")]),_v(" of this component is specified in "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-W12-3/tp/blob/master/src/main/java/seedu/address/ui/Ui.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Ui.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-W12-3/tp/blob/master/src/main/java/seedu/address/logic/Logic.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-W12-3/tp/blob/master/src/main/java/seedu/address/model/Model.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-W12-3/tp/blob/master/src/main/java/seedu/address/storage/Storage.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The add command allows users to add a new contact to the addressbook with required and optional fields.\nThe command format is as follows:"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/NAME ct/CONTACT_TYPE [h/TELEGRAM_HANDLE] [p/PHONE_NUMBER] [e/EMAIL] [m/MODULE] [r/REMARK] [t/TAG]…​")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Required fields")]),_v(": "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NAME")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CONTACT_TYPE")]),_v(", at least one of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TELEGRAM_HANDLE")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PHONE_NUMBER")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EMAIL")])]),_v(" "),_c('li',[_c('strong',[_v("Optional fields")]),_v(": "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TELEGRAM_HANDLE")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PHONE_NUMBER")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EMAIL")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("MODULE")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("REMARK")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TAG")])])])}
},function anonymous(
) {
with(this){return _c('p',[_v("The command parser identifies each prefix (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("n/")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ct/")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("h/")]),_v(") and stores the associated data in a new contact.\nThe optional fields allow users to include more detailed information, making the contact record customizable.")])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"key-components-and-operations"}},[_v("Key Components and Operations"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#key-components-and-operations","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Parser")]),_v(" "),_c('ul',[_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Parser")]),_v(" component processes the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" command string to extract required and optional fields.")]),_v(" "),_c('li',[_v("It uses prefixes ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("n/")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ct/")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("h/")]),_v(", etc.) to correctly identify each piece of data and verify that required fields\n("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NAME")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CONTACT_TYPE")]),_v(" and one of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TELEGRAM_HANDLE")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PHONE_NUMBER")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EMAIL")]),_v(") are present. If any required field is missing,\nan error is raised, prompting the user to provide the necessary information.")])])]),_v(" "),_c('li',[_c('strong',[_v("Logic Manager")]),_v(" "),_c('ul',[_c('li',[_v("The parsed information is passed to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager#execute()")]),_v(", which transfers control to the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage")]),_v(" component")])])]),_v(" "),_c('li',[_c('strong',[_v("Storage")]),_v(" "),_c('ul',[_c('li',[_v("The information is stored using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("JsonAddressBookStorage#saveAddressBook()")]),_v(" method which calls the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("JsonSerializableAddressBook")]),_v("\nconstructor, to create an object that can be serialized in JSON format.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Field Flexibility")]),_v(" "),_c('ul',[_c('li',[_v("Optional fields allow users to store as much or as little information as needed.")]),_v(" "),_c('li',[_v("The design enables future expansion if additional fields are required, with only a need of minor adjustments to the parser.")])])]),_v(" "),_c('li',[_c('strong',[_v("Error Handling")]),_v(" "),_c('ul',[_c('li',[_v("Required fields are validated to prevent incomplete records.")]),_v(" "),_c('li',[_v("Invalid formats (e.g. incorrectly formatted phone numbers or emails) are checked and validated to maintain data consistency.")])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"switch-theme-feature"}},[_v("Switch Theme feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#switch-theme-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The switch theme command allows users to change the display to \"light\" mode or \"dark\" mode according to their preference. The preferred theme will be stored and displayed every time the user opens the app."),_c('br'),_v("\nThe command format is as follows:"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("switch THEME​")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("THEME")]),_v(" can be either 'light' or 'dark'")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"key-components-and-operations-2"}},[_v("Key Components and Operations"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#key-components-and-operations-2","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Parser (SwitchThemeCommandParser)")]),_v(" "),_c('ul',[_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Parser")]),_v(" component processes the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("switch")]),_v(" command string to extract the requested theme ('light' or 'dark'), creating a new "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("SwitchThemeCommand")]),_v(" with the specified theme.")]),_v(" "),_c('li',[_v("If the input format is invalid, a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ParseException")]),_v(" is raised with an error message, prompting users to enter a valid input.")])])]),_v(" "),_c('li',[_c('strong',[_v("Logic (SwitchThemeCommand)")]),_v(" "),_c('ul',[_c('li',[_v("After parsing, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("SwitchThemeCommand#execute")]),_v(" calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ThemeController.switchTheme()")]),_v(" to apply the new theme.")]),_v(" "),_c('li',[_v("A message is returned to the user to confirm the theme change.")])])]),_v(" "),_c('li',[_c('strong',[_v("UI (ThemeController)")]),_v(" "),_c('ul',[_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ThemeController")]),_v(" clears current stylesheets, applies the specified stylesheet and logs the theme change.")]),_v(" "),_c('li',[_v("The selected theme is stored via "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ThemePreference.setTheme()")]),_v(", which calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("saveThemePreference()")]),_v(" to update the JSON file.")])])]),_v(" "),_c('li',[_c('strong',[_v("Storage (ThemePreference)")]),_v(" "),_c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ThemePreference")]),_v(" loads the saved theme from "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("themePreference.json")]),_v(", or defaults to 'LIGHT' if none is found.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("User experience")]),_v(" "),_c('ul',[_c('li',[_v("After executing "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("SwitchThemeCommand")]),_v(", users receive immediate confirmation of the theme change, providing clarity and an improved experience.")]),_v(" "),_c('li',[_v("Saving the user's theme preference ensures a consistent experience each time the application is launched, enhancing usability.")])])]),_v(" "),_c('li',[_c('strong',[_v("Error Handling")]),_v(" "),_c('ul',[_c('li',[_v("Invalid theme inputs raises clear errors, guiding users on valid options.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ThemePreference")]),_v(" manages file I/O errors with warnings, defaulting to \"LIGHT\" if any issues arise with loading or saving preferences.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("university student who\n"),_c('ul',[_c('li',[_v("meets people from many different places (e.g. different classes, CCAs, student accomodation, etc.)")]),_v(" "),_c('li',[_v("have a need to manage a significant number of contacts")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("new user")]),_v(" "),_c('td',[_v("easily access usage instructions")]),_v(" "),_c('td',[_v("refer to instructions when I forget how to use the App")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("add new contacts with their details (eg. name, telegram handle, contact type, module)")]),_v(" "),_c('td',[_v("keep track of my university contacts in the app")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("delete a contact")]),_v(" "),_c('td',[_v("remove entries that I no longer need for university")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("find a person by name, telegram handle or tag")]),_v(" "),_c('td',[_v("locate details of persons without having to go through the entire list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("edit contact details (e.g. phone number, email)")]),_v(" "),_c('td',[_v("so that I can keep the information of my university contacts up to date")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("add a new contact with multiple tags (e.g., CCA, classmate)")]),_v(" "),_c('td',[_v("categorise them based on different associations")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("categorise contacts into different contact types (eg. work, personal)")]),_v(" "),_c('td',[_v("organise people according to my needs")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("be able to filter my contacts based off different contact types")]),_v(" "),_c('td',[_v("find my contacts faster")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("tag contacts with multiple categories")]),_v(" "),_c('td',[_v("find them easily in different contexts")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("import contacts from csv files")]),_v(" "),_c('td',[_v("quickly add a large number of contacts without entering them manually")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("receive reminders to reach out to contacts I haven’t communicated with in a while")]),_v(" "),_c('td',[_v("maintain my connections")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UniLink")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC001 - Add a new contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a new contact")])]),_v(" "),_c('li',[_c('p',[_v("User enters the required contact details")])]),_v(" "),_c('li',[_c('p',[_v("UniLink validates the entered details")])]),_v(" "),_c('li',[_c('p',[_v("UniLink adds the new contact")])]),_v(" "),_c('li',[_c('p',[_v("UniLink displays the updated contact list")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. The entered data is invalid")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. UniLink shows an error message indicating fields that could be incorrect.")])]),_v(" "),_c('li',[_c('p',[_v("3a2. User re-enters the new data")]),_v(" "),_c('p',[_v("Steps 3a1-3a2 are repeated until the data entered is correct.")]),_v(" "),_c('p',[_v("Use case resumes from step 4.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. User enters a duplicate contact.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3b1. UniLink shows an error message indicating the contact already exists.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons")])]),_v(" "),_c('li',[_c('p',[_v("UniLink shows a list of persons")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific person in the list")])]),_v(" "),_c('li',[_c('p',[_v("UniLink deletes the specified person from the list")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons")])]),_v(" "),_c('li',[_c('p',[_v("UniLink shows a list of persons")])]),_v(" "),_c('li',[_c('p',[_v("User requests to edit a specific person in the list")])]),_v(" "),_c('li',[_c('p',[_v("User enters the new details for the contact to be updated")])]),_v(" "),_c('li',[_c('p',[_v("UniLink updates the contact")])]),_v(" "),_c('li',[_c('p',[_v("UniLink displays the updated contact list")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. UniLink shows an error message indicating the index is invalid.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("4a. The entered data is invalid")]),_v(" "),_c('ul',[_c('li',[_v("4a1. UniLink shows an error message indicating fields that could be invalid.")]),_v(" "),_c('li',[_v("4a2. User re-enters the new data")])]),_v(" "),_c('p',[_v("Steps 4a1-4a2 are repeated until the data entered is correct.")]),_v(" "),_c('p',[_v("Use case resumes from step 5.")])]),_v(" "),_c('li',[_c('p',[_v("4b. The edited contact results in a duplicate")]),_v(" "),_c('ul',[_c('li',[_v("4b1. UniLink shows an error message indicating that a duplicate contact already exists.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view the list of persons")])]),_v(" "),_c('li',[_c('p',[_v("UniLink shows the full list of persons with basic contact details.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC005 - Switch Theme")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to switch theme")])]),_v(" "),_c('li',[_c('p',[_v("UniLink changes the theme to the specified option (e.g., light or dark mode)")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to find contacts by name")])]),_v(" "),_c('li',[_c('p',[_v("User enters a keyword representing part or all of a contact’s name")])]),_v(" "),_c('li',[_c('p',[_v("UniLink shows a list of persons with names containing the keyword")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The entered data is invalid")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. UniLink shows an error message")])]),_v(" "),_c('li',[_c('p',[_v("2a2. User re-enters a new keyword")]),_v(" "),_c('p',[_v("Steps 2a1-2a2 are repeated until the data entered is correct.")]),_v(" "),_c('p',[_v("Use case resumes from step 3.")])])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to filter contacts by contact type")])]),_v(" "),_c('li',[_c('p',[_v("User specifies the contact type they want to filter by")])]),_v(" "),_c('li',[_c('p',[_v("UniLink shows a list of contacts that match the specified contact type")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The specified contact type is invalid")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. UniLink shows an error message indicating the contact type is invalid")]),_v(" "),_c('p',[_v("Use case resumes from step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("3a. No contacts match the specified contact type")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should be able to hold up to 1000 persons without a noticeable sluggishness in performance for typical usage. (Efficiency and performance)")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse. (Accessibility)")]),_v(" "),_c('li',[_v("The system should work on common desktop operating systems, including Windows, macOS, and Linux. (Environment)")]),_v(" "),_c('li',[_v("The system must include comprehensive user and developer documentation to support easy onboarding for both end-users and future developers. (Documentation)")]),_v(" "),_c('li',[_v("The system should be modular and follow an OOP (Object-Oriented Programming) approach, allowing for easy feature extensions or modifications. (maintainability)")]),_v(" "),_c('li',[_v("The system’s user interface should be intuitive and require no more than 10 minutes of learning for a new user. (UX)")]),_v(" "),_c('li',[_v("The system should undergo regular code reviews to maintain high code quality. (Quality)")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Architecture Diagram")]),_v(": A visual representation of the system's structure, showing components and their relationships.")]),_v(" "),_c('li',[_c('strong',[_v("JSON")]),_v(": JavaScript Object Notation, /    A lightweight data-interchange format used to represent structured data, often in key-value pairs.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Adding a person with minimum fields (name, contact type, telegram handle)")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Nicole Lee ct/work h/@nicole_lee")]),_c('br'),_v("\nExpected: New contact added to the list with the details provided. Details of the added contact are shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Nicole 333 ct/work h/@nicole_lee")]),_c('br'),_v("\nExpected: No person added. Error details displayed in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect add commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Nicole Lee")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add Nicole Lee")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_c('br'),_v("\nExpected: Similar to previous.")])])])]),_v(" "),_c('li',[_c('p',[_v("Adding a person with all fields (name, contact type, telegram handle, phone number, email, module, remark, tags)")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Nicole Lee ct/work h/@nicole_lee p/98765432 e/nicolelee@example.com m/CS2103T r/likes coding t/friend")]),_c('br'),_v("\nExpected: New contact added to the list with the details provided. Details of the added contact are shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Nicole Lee ct/work h/@nicole_lee p/98765432 e/nicolelee@example.com m/CS2103T r/likes coding t/friend t/colleague t/student")]),_c('br'),_v("\nExpected: New contact added to the list with the details provided. Details of the added contact are shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add Nicole Lee work @nicole_lee 98765432 nicole@example.com CS2103T likes coding friend")]),_v("\nExpected: No person added. Error details displayed in the status message.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"editing-a-person-s-contact-details"}},[_v("Editing a person's contact details"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#editing-a-person-s-contact-details","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Editing a person's telegram handle from an existing contact")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all persons using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple persons in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 h/@ashley_")]),_c('br'),_v("\nExpected: Telegram handle of first contact updated to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("@ashley_")]),_v(". Details of the edited contact are shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 0 h/@ashley_")]),_c('br'),_v("\nExpected: No person is edited. Error details shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect edit commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit h/@ashley_")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 @ashley_")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit x @ashley_")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is larger than the list size)"),_c('br'),_v("\nExpected: Similar to previous.")])])])]),_v(" "),_c('li',[_c('p',[_v("Editing multiple fields for an existing contact (e.g. email, telegram handle)")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all persons using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple persons in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 e/ashley@example.com h/@ashley_")]),_c('br'),_v("\nExpected: Email and telegram handle of first contact is updated to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ashley@example.com")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("@ashley_")]),_v(" respectively. Details of the edited contact are shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 0 e/ashley@example.com h/@ashley_")]),_c('br'),_v("\nExpected: No person is edited. Error details shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect edit commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit e/ashley@example.com h/@ashley_")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 e/ashley@example.com @ashley_")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit e/ashley@example.com h/@ashley_")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_c('br'),_v("\nExpected: Similar to previous.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Dealing with missing data file")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Navigate to ./data/addressbook.json and delete the addressbook.json file.")])]),_v(" "),_c('li',[_c('p',[_v("Launch the app by double-clicking the jar file."),_c('br'),_v("\nExpected: The default list of contacts is loaded.")])])])]),_v(" "),_c('li',[_c('p',[_v("Dealing with corrupted data file")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Navigate to ./data/addressbook.json. Right click the addressbook.json file and open in TextEdit.")])]),_v(" "),_c('li',[_c('p',[_v("Delete all the contents of the file and type some symbols (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("&*$@")]),_v(").")])]),_v(" "),_c('li',[_c('p',[_v("Launch the app by double-clicking the jar file."),_c('br'),_v("\nExpected: The app loads with no contacts.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"difficulty-level-and-challenges"}},[_v("Difficulty Level and Challenges"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#difficulty-level-and-challenges","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Additional Fields")]),_v(": Our project manages additional fields such as Telegram handle, module, and contact type. Integrating these fields required modifying both data structures and UI components, as well as adapting backend logic to manage and validate these new attributes.")]),_v(" "),_c('li',[_c('strong',[_v("Enhanced Search Functionality")]),_v(": We implemented additional search functionalities, allowing users to find contacts by tags and Telegram handles, in addition to names. This required integration of the find command with additional fields.")]),_v(" "),_c('li',[_c('strong',[_v("UI Enhancements")]),_v(": Significant effort went into redesigning the user interface to make it aesthetically pleasing. In addition to improving layout and visual styling, we introduced both light and dark modes, ensuring each element was clearly visible in both themes.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"effort"}},[_v("Effort"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#effort","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Custom Implementation and Adaptation")]),_v(" The majority of the codebase was custom-developed to meet the specific needs of our project, with very limited reuse of existing libraries or tools beyond those provided in AB3. For example, the additional fields, search functionality, and UI customization were built from scratch, significantly increasing the project’s scope and difficulty level.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"achievement"}},[_v("Achievement"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#achievement","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Our team successfully extended the basic functionality of AB3, transforming it into a more versatile and feature-rich application. The enhanced search capabilities and the addition of new fields significantly improved the usability of the application, allowing for more efficient contact management. The aesthetically refined UI, with support for both light and dark modes, further elevated the user experience and set our project apart from AB3.")])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Mon, 11 Nov 2024, 17:25:02 GMT+8]")])])])}
}];
